...
public class Translate {
    ...
    //Testing out to ensure that it does its basic function.
    /*
    public static void main(String[] args) {

        Translate translator = new Translate();//change it to your own apikey generated by google
        String toConv = "How are you doing?";
        //In this example we are translating the toConv from the enlish language to spanish calling
        //the translator call and then printing out the the console to ensure its working
        String text = translator.translate(toConv, "en" ,"es");
